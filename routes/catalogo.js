...
router.get("/finalizar", auth.cliente, actCarrito, opCarrito, session.cliente, controller.finalizar);
router.post("/checkout", auth.cliente, actCarrito, opCarrito, session.cliente, controller.checkout);
